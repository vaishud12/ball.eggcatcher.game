...
win = Tk()
c = Canvas(win , width = canvas_width ,  height = canvas_height , background = 'yellow')
c.create_rectangle(-5, canvas_height - 50 , canvas_width + 3 , canvas_height + 2 , fill='light blue', width=0)
c.create_oval(-80,-80,120,120,fill='purple' , width=0)
c.pack()

color_cycle = cycle(['blue' , 'pink' , 'purple', 'orange' , 'red', 'blue' , 'green','black'])
egg_width = 50
egg_height = 40
egg_score = 10
egg_speed = 500
...
catcher_width = 150
catcher_height = 200
catcher_start_x = canvas_width / 4 - catcher_width / 4
